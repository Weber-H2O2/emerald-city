...
pub async fn gg18_sign_round0(context: String) -> String {
...
pub async fn gg18_sign_round4() -> String {
    ...
    bc1_vec.remove(usize::from(context.party_num_int - 1));
...
pub async fn gg18_sign_round6() -> String {
    ...
    commit5a_vec.remove(usize::from(context.party_num_int - 1));
